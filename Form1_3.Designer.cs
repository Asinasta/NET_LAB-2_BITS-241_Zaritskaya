namespace NET_LAB_2_BITS_241_Zaritskaya
{
    partial class Form1_3
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Для того чтобы определить количество корней квадратного уравнения, нужно вычислит" +
    "ь дискриминант по формуле";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Формула D = b^2 - 4ac, где:\r\na — коэффициент при x^2\r\nb — коэффициент при x\r\nc — " +
    "свободный член\r\n";
            // 
            // textBox1
            // 
            ...
            this.textBox1.TextChanged += new System.EventHandler(this.textBox_a_TextChanged);
            // 
            // textBox2
            // 
            ...
            this.textBox2.TextChanged += new System.EventHandler(this.textBox_b_TextChanged);
            // 
            // textBox3
            // 
            ...
            this.textBox3.TextChanged += new System.EventHandler(this.textBox_c_TextChanged);
            // 
            // label_a
            // 
